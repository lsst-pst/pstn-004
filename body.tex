...
(see LSE-79 and LSE-390 for details) will likely continue into the operations phase, the majority 
of anticipated documents are required to enable efficient and robust early science with the LSST 
