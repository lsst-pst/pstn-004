...
\end{verbatim}
\LPG[inline]{Suggest: "LSST Data Management Quality Assurance and Reliability Engineering".  Only some of the tools for DM System Verification are provided by SQuaRE. Other tools are provided by the Architecture team and the actual system level verification is led by the DM Science Team.}
\begin{verbatim}
domain: Data Management 
...
\end{verbatim}
\LPG[inline]{Add a paper for DM system Verification and Validation} 
\begin{verbatim}
domain: Data Management 
